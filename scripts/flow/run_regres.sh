...
# Baseline 4x8
# -----------------------------------------------------------------------------
run "sim          Baseline 4x8"  sim          TOP_LEVEL=top_bas_4x8  CLK_PERIOD_NS=$CLK  OUT_DIR=bas_4x8_sim                                    PARAMS="IS_PIPELINED=1 MULT_TYPE=0 MAX_VAL_A=7 MAX_VAL_B=127 DIST_TYPE=0"
run "syn          Baseline 4x8"  syn          TOP_LEVEL=top_bas_4x8                      OUT_DIR=bas_4x8_syn                                    PARAMS="IS_PIPELINED=1 MULT_TYPE=0"
run "post-syn-sim Baseline 4x8"  post-syn-sim TOP_LEVEL=top_bas_4x8  CLK_PERIOD_NS=$CLK  OUT_DIR=bas_4x8_post_syn_sim  NETLIST_DIR=bas_4x8_syn  PARAMS="IS_PIPELINED=1 MULT_TYPE=0 MAX_VAL_A=7 MAX_VAL_B=127 DIST_TYPE=0"
...
# Baseline 8x8
# -----------------------------------------------------------------------------
run "sim          Baseline 8x8"  sim          TOP_LEVEL=top_bas_8x8  CLK_PERIOD_NS=$CLK  OUT_DIR=bas_8x8_sim                                    PARAMS="IS_PIPELINED=1 MULT_TYPE=0 MAX_VAL_A=127 MAX_VAL_B=127 DIST_TYPE=0"
run "syn          Baseline 8x8"  syn          TOP_LEVEL=top_bas_8x8                      OUT_DIR=bas_8x8_syn                                    PARAMS="IS_PIPELINED=1 MULT_TYPE=0"
run "post-syn-sim Baseline 8x8"  post-syn-sim TOP_LEVEL=top_bas_8x8  CLK_PERIOD_NS=$CLK  OUT_DIR=bas_8x8_post_syn_sim  NETLIST_DIR=bas_8x8_syn  PARAMS="IS_PIPELINED=1 MULT_TYPE=0 MAX_VAL_A=127 MAX_VAL_B=127 DIST_TYPE=0"
...
# Baseline 4x8 SC
# -----------------------------------------------------------------------------
run "sim          Baseline 4x8 SC"  sim          TOP_LEVEL=top_bas_4x8_sc  CLK_PERIOD_NS=$CLK  OUT_DIR=bas_4x8_sc_sim                                       PARAMS="IS_PIPELINED=1 MULT_TYPE=0 MAX_VAL_A=7 MAX_VAL_B=127 DIST_TYPE=0"
run "syn          Baseline 4x8 SC"  syn          TOP_LEVEL=top_bas_4x8_sc                      OUT_DIR=bas_4x8_sc_syn                                       PARAMS="IS_PIPELINED=1 MULT_TYPE=0"
run "post-syn-sim Baseline 4x8 SC"  post-syn-sim TOP_LEVEL=top_bas_4x8_sc  CLK_PERIOD_NS=$CLK  OUT_DIR=bas_4x8_sc_post_syn_sim  NETLIST_DIR=bas_4x8_sc_syn  PARAMS="IS_PIPELINED=1 MULT_TYPE=0 MAX_VAL_A=7 MAX_VAL_B=127 DIST_TYPE=0"
...
# Winograd 4x8
# -----------------------------------------------------------------------------
run "sim          Winograd 4x8"  sim          TOP_LEVEL=top_win_4x8  CLK_PERIOD_NS=$CLK  OUT_DIR=win_4x8_sim                                    PARAMS="IS_PIPELINED=1 MULT_TYPE=0 MAX_VAL_A=7 MAX_VAL_B=127 DIST_TYPE=0"
run "syn          Winograd 4x8"  syn          TOP_LEVEL=top_win_4x8                      OUT_DIR=win_4x8_syn                                    PARAMS="IS_PIPELINED=1 MULT_TYPE=0"
run "post-syn-sim Winograd 4x8"  post-syn-sim TOP_LEVEL=top_win_4x8  CLK_PERIOD_NS=$CLK  OUT_DIR=win_4x8_post_syn_sim  NETLIST_DIR=win_4x8_syn  PARAMS="IS_PIPELINED=1 MULT_TYPE=0 MAX_VAL_A=7 MAX_VAL_B=127 DIST_TYPE=0"
...
# Winograd 4x8 SC
# -----------------------------------------------------------------------------
run "sim          Winograd 4x8 SC"  sim          TOP_LEVEL=top_win_4x8_sc  CLK_PERIOD_NS=$CLK  OUT_DIR=win_4x8_sc_sim                                       PARAMS="IS_PIPELINED=1 MULT_TYPE=0 MAX_VAL_A=7 MAX_VAL_B=127 DIST_TYPE=0"
run "syn          Winograd 4x8 SC"  syn          TOP_LEVEL=top_win_4x8_sc                      OUT_DIR=win_4x8_sc_syn                                       PARAMS="IS_PIPELINED=1 MULT_TYPE=0"
run "post-syn-sim Winograd 4x8 SC"  post-syn-sim TOP_LEVEL=top_win_4x8_sc  CLK_PERIOD_NS=$CLK  OUT_DIR=win_4x8_sc_post_syn_sim  NETLIST_DIR=win_4x8_sc_syn  PARAMS="IS_PIPELINED=1 MULT_TYPE=0 MAX_VAL_A=7 MAX_VAL_B=127 DIST_TYPE=0"
...
# Square 4x8 SC
# -----------------------------------------------------------------------------
run "sim          Square 4x8 SC"  sim          TOP_LEVEL=top_sqr_4x8_sc  CLK_PERIOD_NS=$CLK  OUT_DIR=sqr_4x8_sc_sim                                       PARAMS="IS_PIPELINED=1 MAX_VAL_A=7 MAX_VAL_B=127 DIST_TYPE=0"
run "syn          Square 4x8 SC"  syn          TOP_LEVEL=top_sqr_4x8_sc                      OUT_DIR=sqr_4x8_sc_syn                                       PARAMS="IS_PIPELINED=1"
run "post-syn-sim Square 4x8 SC"  post-syn-sim TOP_LEVEL=top_sqr_4x8_sc  CLK_PERIOD_NS=$CLK  OUT_DIR=sqr_4x8_sc_post_syn_sim  NETLIST_DIR=sqr_4x8_sc_syn  PARAMS="IS_PIPELINED=1 MAX_VAL_A=7 MAX_VAL_B=127 DIST_TYPE=0"
...
# Square 8x8
# -----------------------------------------------------------------------------
run "sim          Square 8x8"  sim          TOP_LEVEL=top_sqr_8x8  CLK_PERIOD_NS=$CLK  OUT_DIR=sqr_8x8_sim                                    PARAMS="IS_PIPELINED=1 MAX_VAL_A=127 MAX_VAL_B=127 DIST_TYPE=0"
run "syn          Square 8x8"  syn          TOP_LEVEL=top_sqr_8x8                      OUT_DIR=sqr_8x8_syn                                    PARAMS="IS_PIPELINED=1"
run "post-syn-sim Square 8x8"  post-syn-sim TOP_LEVEL=top_sqr_8x8  CLK_PERIOD_NS=$CLK  OUT_DIR=sqr_8x8_post_syn_sim  NETLIST_DIR=sqr_8x8_syn  PARAMS="IS_PIPELINED=1 MAX_VAL_A=127 MAX_VAL_B=127 DIST_TYPE=0"
...
# Square 4x8 Alpha
# -----------------------------------------------------------------------------
run "sim          Alpha"  sim          TOP_LEVEL=top_sqr_4x8_sc_alpha  CLK_PERIOD_NS=$CLK  OUT_DIR=sqr_4x8_alpha_sim                                          PARAMS="IS_PIPELINED=1 IS_SQUARE=0 MAX_VAL_A=7 DIST_TYPE=0"
run "syn          Alpha"  syn          TOP_LEVEL=top_sqr_4x8_sc_alpha                      OUT_DIR=sqr_4x8_alpha_syn                                          PARAMS="IS_PIPELINED=1 IS_SQUARE=0"
run "post-syn-sim Alpha"  post-syn-sim TOP_LEVEL=top_sqr_4x8_sc_alpha  CLK_PERIOD_NS=$CLK  OUT_DIR=sqr_4x8_alpha_post_syn_sim  NETLIST_DIR=sqr_4x8_alpha_syn  PARAMS="IS_PIPELINED=1 IS_SQUARE=0 MAX_VAL_A=7 DIST_TYPE=0"
...
# -----------------------------------------------------------------------------
run "sim          Alpha Squared"  sim          TOP_LEVEL=top_sqr_4x8_sc_alpha  CLK_PERIOD_NS=$CLK  OUT_DIR=sqr_4x8_alpha_sqr_sim                                              PARAMS="IS_PIPELINED=1 IS_SQUARE=1 MAX_VAL_A=7 DIST_TYPE=0"
run "syn          Alpha Squared"  syn          TOP_LEVEL=top_sqr_4x8_sc_alpha                      OUT_DIR=sqr_4x8_alpha_sqr_syn                                              PARAMS="IS_PIPELINED=1 IS_SQUARE=1"
run "post-syn-sim Alpha Squared"  post-syn-sim TOP_LEVEL=top_sqr_4x8_sc_alpha  CLK_PERIOD_NS=$CLK  OUT_DIR=sqr_4x8_alpha_sqr_post_syn_sim  NETLIST_DIR=sqr_4x8_alpha_sqr_syn  PARAMS="IS_PIPELINED=1 IS_SQUARE=1 MAX_VAL_A=7 DIST_TYPE=0"
...
# Square 8x8 Alpha
# -----------------------------------------------------------------------------
run "sim          Square 8x8 Alpha"  sim          TOP_LEVEL=top_sqr_8x8_alpha  CLK_PERIOD_NS=$CLK  OUT_DIR=sqr_8x8_alpha_sim                                          PARAMS="IS_PIPELINED=1 IS_SQUARE=0 MAX_VAL_A=127 DIST_TYPE=0"
run "syn          Square 8x8 Alpha"  syn          TOP_LEVEL=top_sqr_8x8_alpha                      OUT_DIR=sqr_8x8_alpha_syn                                          PARAMS="IS_PIPELINED=1 IS_SQUARE=0"
run "post-syn-sim Square 8x8 Alpha"  post-syn-sim TOP_LEVEL=top_sqr_8x8_alpha  CLK_PERIOD_NS=$CLK  OUT_DIR=sqr_8x8_alpha_post_syn_sim  NETLIST_DIR=sqr_8x8_alpha_syn  PARAMS="IS_PIPELINED=1 IS_SQUARE=0 MAX_VAL_A=127 DIST_TYPE=0"
...
# -----------------------------------------------------------------------------
run "sim          Square 8x8 Alpha Squared"  sim          TOP_LEVEL=top_sqr_8x8_alpha  CLK_PERIOD_NS=$CLK  OUT_DIR=sqr_8x8_alpha_sqr_sim                                              PARAMS="IS_PIPELINED=1 IS_SQUARE=1 MAX_VAL_A=127 DIST_TYPE=0"
...
run "post-syn-sim Square 8x8 Alpha Squared"  post-syn-sim TOP_LEVEL=top_sqr_8x8_alpha  CLK_PERIOD_NS=$CLK  OUT_DIR=sqr_8x8_alpha_sqr_post_syn_sim  NETLIST_DIR=sqr_8x8_alpha_sqr_syn  PARAMS="IS_PIPELINED=1 IS_SQUARE=1 MAX_VAL_A=127 DIST_TYPE=0"
