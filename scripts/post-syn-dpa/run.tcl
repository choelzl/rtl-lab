...
set REPORT_DIR $env(RTL_LAB_HOME)/projects/$env(SEL_PROJECT)/imp/$env(SEL_OUT_DIR)/report
...
# -----------------------------------------------------------------------------
read_verilog $env(RTL_LAB_HOME)/projects/$env(SEL_PROJECT)/imp/$env(SEL_NETLIST_DIR)/output/netlist.v
...
# -----------------------------------------------------------------------------
set vcd_verilator "$env(RTL_LAB_HOME)/projects/$env(SEL_PROJECT)/sim/$env(SEL_VCD_DIR)/output/activity.vcd"
