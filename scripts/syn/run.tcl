...
source $env(RTL_LAB_HOME)/scripts/syn/compile.tcl
...
yosys "abc \
    ...
    -script  $env(RTL_LAB_HOME)/scripts/syn/abc.tcl"
...
# -----------------------------------------------------------------------------
yosys "tee -o $env(RTL_LAB_HOME)/projects/$env(SEL_PROJECT)/imp/$env(SEL_OUT_DIR)/report/area.rpt stat -hierarchy \
...
# -----------------------------------------------------------------------------
yosys "write_verilog -noattr -noexpr -nodec $env(RTL_LAB_HOME)/projects/$env(SEL_PROJECT)/imp/$env(SEL_OUT_DIR)/output/netlist.v"
